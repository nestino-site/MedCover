export const en = {
  ...
  clinicPdp: {
    ...
    atAGlance: {
      ...
      googleReviews: '{rating} · {count} Google reviews',
      interviews: '{count} verified interview',
      interviewsPlural: '{count} verified interviews',
    ...
    sections: {
      ...
      treatments: { eyebrow: 'Services', title: 'Treatments offered', titleWithCount: 'Treatments offered ({count})', viewTreatment: 'View clinics →' },
      pricing: { eyebrow: 'Packages', title: 'Pricing packages', featured: 'Featured package', verified: 'Verified' },
    ...
    reviews: {
      ...
      readLess: 'Read less',
      stars: '{count} star',
      starsPlural: '{count} stars',
    },
    compareTeaser: {
      eyebrow: 'Compare',
      title: 'Compare with other clinics in {city}',
      description: 'See how this clinic stacks up against {count} other verified clinics in the same city.',
      cta: 'Browse clinics in {city} →',
    },
